    ...
    <div class="layuimini-main">
        ...
        <form class="layui-form" lay-filter="example">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" placeholder="请选择角色" autocomplete="off" class="layui-input" id="demo" value="{{$names}}" ts-selected="{{$info->role_id ?? ''}}">
                    <input type="hidden" value="{{$info->role_id ?? ''}}" name="roles">
                </div>
            </div>
