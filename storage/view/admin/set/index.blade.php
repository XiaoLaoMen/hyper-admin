                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="layui-upload-list">
                                <img class="layui-upload-img" id="demo1" src="{{$v->val ?? ''}}">
                                <div class="layui-form-mid layui-word-aux">建议高度为50px</div>
                                <input type="hidden" name="logo" value="{{$v->val ?? ''}}">
                                <p id="demoText"></p>
                            </div>
                        </div>
                    </div>
                ...
                @if($v->key=='icon')
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="layui-upload-list">
                                <img class="layui-upload-img" id="demo11" src="{{$v->val ?? ''}}">
                                <div class="layui-form-mid layui-word-aux">标题栏旁边图标，建议大小32*32</div>
                                <input type="hidden" name="icon" value="{{$v->val ?? ''}}">
                                <p id="demoText1"></p>
                            </div>
                        </div>
                    </div>
                @endif
                    @if($v->key=='upload_ext')
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="upload_ext" autocomplete="off" placeholder="上传后缀" class="layui-input" value="{{$v->val ?? ''}}">
                            </div>
                        </div>
                    @endif
                    @if($v->key=='upload_mime')
                        <div class="layui-form-item">
                            <label class="layui-form-label">上传类型</label>
                            <div class="layui-input-block">
                                <input type="text" name="upload_mime" autocomplete="off" placeholder="上传类型" class="layui-input" value="{{$v->val ?? ''}}">
                            </div>
                        </div>
                    @endif
                    @if($v->key=='upload_image_size')
                        <div class="layui-form-item">
                            <label class="layui-form-label">上传图片大小</label>
                            <div class="layui-input-block">
                                <input type="text" name="upload_image_size" autocomplete="off" placeholder="上传图片大小" class="layui-input" value="{{$v->val ?? ''}}">
                            </div>
                        </div>
                    @endif
            @endforeach
