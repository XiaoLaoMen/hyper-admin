        ...
        renderPageTitle: function (href, options) {
            ...
            if (pageTitleArray.length > 0) {
                ...
                if (title === null || title === undefined || title === '') {
                    ...
                    var strtit = title.split("/");
                    for (var kt in strtit){
                        kt = parseInt(kt);
                        if(kt !== strtit.length - 1){
                            pageTitleHtml += '<a><cite>' + strtit[kt] + '</cite></a><span lay-separator="">/</span>\n';
                        }else{
                            pageTitleHtml += '<a><cite>' + strtit[kt]  + '</cite></a>\n';
                        }
