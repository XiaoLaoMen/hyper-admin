...
<script>
    layui.use(['form', 'table','form','element','ajax'], function () {
        ...
        var a_title = "<?php echo \Hyperf\ViewEngine\T::e($admin_menu_url['/admin/admin/page']); ?>";
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                $(this).attr('layuimini-content-href',new_href);
                $(this).attr('data-title',"<?php echo \Hyperf\ViewEngine\T::e($admin_menu_url['/admin/admin/auth']); ?>");
...
<?php /**PATH /home/nicaine/Desktop/wwwroot/www.b.com/storage/view/admin/admin/index.blade.php ENDPATH**/ ?>