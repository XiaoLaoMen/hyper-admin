...
class LoginController extends AbstractController
{
    ...
    public function login(LoginRequest $request, Encrypt $encrypt, Admin $admin)
    {
        ...
        return $this->response->withCookie($cookie)->withContent(json_encode($this->helper->getSuccess([], '登录成功,正在跳转请稍后...')));
    }
    /**
    ...
    public function signout()
    {
        ...
        return $this->response->withCookie($cookie)->withContent(json_encode($this->helper->getSuccess([], '退出成功,正在跳转请稍后...')));
    }
}